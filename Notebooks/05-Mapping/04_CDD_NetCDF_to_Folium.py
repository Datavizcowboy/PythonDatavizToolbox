...
d10_file = '/Users/datavizcowboy/Documents/Fuel/ANTICIPA/CDD_avg.nc'
...
cvals  = [0.1,100,200,300,400,1000]
norm=plt.Normalize(min(cvals),max(cvals))
tuples = list(zip(map(norm,cvals), colors))
cmap = matplotlib.colors.LinearSegmentedColormap.from_list("", tuples)
#cmap = 'gist_heat'

contourf = plt.contourf(lons,lats,var,levels=cvals,vmin=0.0001, vmax=1000,alpha=1, cmap=cmap,norm=norm);
...
m.save('/Users/datavizcowboy/Sites/MITIGA/Anticipa/Folium/index.html')
