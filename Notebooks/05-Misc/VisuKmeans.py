		...
		for j1 in range(len(y)): 
			...
			for i2 in range(len(x)):
				for j2 in range(len(y)): 
					...
					#on stoke la distance et la position des centres aprs convergence
...
if __name__ == "__main__":
	...
	# calcul de tous les kmeans sur la grille. On rcpr kes valeurrs de distance diffrentes et les positions des centres
	nx, ny = 5,5
